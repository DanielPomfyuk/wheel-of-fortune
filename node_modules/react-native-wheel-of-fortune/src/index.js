...
class WheelOfFortune extends Component {
    ...
    makeWheel = () => {
        ...
        console.log(arcs);
        var colors = this.props.colors ? this.props.colors : ['#E07029', '#E899', '#ABC937', '#4F991D', '#22AFD3', '#5858D0', '#7B48C8', '#D843B9', '#E23B80', '#D82B2B'];
        return arcs.map((arc, index) => {
            const instance = d3Shape
                .arc()
                .padAngle(0.01)
                .outerRadius(width/2)
                .innerRadius( this.props.innerRadius || 150 );
            return {
                path: instance(arc),
                color: colors[index],
            ...
            if (this.props.playButton) {
                ...
                return (
                    <View style={styles.modal}>
                        <TouchableOpacity onPress={() => this._onPress()}>
                            <RNText style={styles.startText}>TAP TO PLAY</RNText>
                        </TouchableOpacity>
                    </View>
                );
            }
